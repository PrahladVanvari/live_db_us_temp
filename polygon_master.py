...
# from data_producers import create_index_websocket_client, create_options_websocket_client, run_with_reconnect, indices_data_producer, options_data_producer, index_logger, options_logger
    ...
    while running:
        try:
            ...
            if isinstance(market_data, IndexValue):
                ...
                last_minute = consume_options_trade_msg(market_data, last_minute, queue1.qsize(), redis, queue_name)
...
if __name__ == "__main__":
    ...
    # index_producer_process = mp.Process(
    # target=run_with_reconnect,
    # args=(create_index_websocket_client, indices_data_producer, index_logger, 'Index WS')
    # )
    # options_producer_process = mp.Process(
    # target=run_with_reconnect,
    # args=(create_options_websocket_client, options_data_producer, options_logger, "Options WS")
    # )

    #  Old Version To Start Producer
